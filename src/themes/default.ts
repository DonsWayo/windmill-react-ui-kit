export default {
  ...
  alert: {
    ...
    withClose: "pr-12",
    success:
      "bg-safeguru-50 text-yellow-900 dark:bg-safeguru-600 dark:text-white",
    ...
    icon: {
      base: "h-5 w-5",
      success: "text-yellow-400 dark:text-yellow-300",
    ...
    // TableBody
    tableBody: {
      base: "bg-white divide-y divide-gray-100 dark:divide-gray-700  text-gray-700 dark:text-gray-400",
    },
    // DropdownItem
    ...
    badge: {
      ...
      success:
        "text-green-500 bg-green-100 dark:bg-green-800 dark:text-yellow-100",
      danger: "text-red-500 bg-red-100 dark:text-red-100 dark:bg-red-800",
      warning:
        "text-yellow-500 bg-safeguru-100 dark:text-white dark:bg-safeguru-600",
    ...
    textarea: {
      ...
      valid:
        "border-yellow-600 dark:bg-gray-700 focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring focus:ring-yellow-200 dark:focus:ring-yellow-200",
      invalid:
    ...
    select: {
      ...
      active:
        "focus:border-gray-200 border-gray-200 dark:border-gray-600 focus:shadow-none focus:ring focus:ring-yellow-300 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700",
      select: "leading-5",
      disabled: "cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800",
      valid:
        "border-yellow-600 dark:bg-gray-700 focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring focus:ring-yellow-200 dark:focus:ring-yellow-200",
    ...
    input: {
      ...
      active:
        "focus:border-gray-200 border-gray-200 dark:border-gray-600 focus:ring focus:ring-yellow-300 dark:focus:border-gray-500 dark:focus:ring-gray-300 dark:bg-gray-700",
      disabled: "cursor-not-allowed opacity-50 bg-gray-300 dark:bg-gray-800",
      valid:
        "border-yellow-600 dark:bg-gray-700 focus:border-yellow-400 dark:focus:border-yellow-400 focus:ring focus:ring-yellow-200 dark:focus:ring-yellow-200",
      invalid:
        "border-red-600 dark:bg-gray-700 focus:border-red-400 dark:focus:border-red-400 focus:ring focus:ring-red-200 dark:focus:ring-red-200",
      radio:
        "text-yellow-500 form-radio focus:border-yellow-400 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-0 dark:focus:ring-gray-300",
      checkbox:
        "text-yellow-500 form-checkbox focus:border-yellow-500 focus:outline-none focus:ring focus:ring-yellow-300 focus:ring-offset-0 rounded dark:focus:ring-gray-300",
    },
    // HelperText
    helperText: {
      base: "text-xs",
      valid: "text-yellow-600 dark:text-yellow-400",
    ...
    // Button
    button: {
      base: "align-bottom inline-flex items-center justify-center cursor-pointer leading-5 transition-colors duration-150 font-medium focus:outline-none rounded-full",
      block: "w-full",
      size: {
      ...
      primary: {
        base: "text-white bg-safeguru border border-transparent",
        active:
          "active:bg-safeguru-600 hover:bg-safeguru-600 focus:ring focus:ring-purple-300",
        disabled: "opacity-50 cursor-not-allowed",
      },
      outline: {
